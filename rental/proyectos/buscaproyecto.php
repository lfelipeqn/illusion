...
function Buscar(){	
    if((document.getElementById('tipob1').checked==false)&&(document.getElementById('tipob2').checked==false)&&(document.getElementById('tipob3').checked==false)&&(document.getElementById('tipob5').checked==false)){
	   ...
	   var direccion='rental.php?location=cproy&tipo='+opcion+'&valor='+nombre
...
<div class="cuerpo">
	...
	<p>Seleccione el Criterio de b&uacute;squeda deseado para Consultar Proyectos</p>
	<form action="" method="post" id="fbusc" name="fbusc">
		<table>
			...
			<tr>
				<td><label><input type="radio" id="tipob1" name="tipob" value="1" />Todos los Proyectos</label></td>
            ...
            <tr>
                <td colspan="4">
                <div align="right">
                    <input type="button" id="bbusc" name="bbusc" style="width:350px; font-weight:bold; background-color:white;" value="Ver Proyectos" onclick="Buscar()" />
                </div>
                </td>
			</tr>
		</table>
