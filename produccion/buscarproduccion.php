...
function Buscar(){
	if((document.getElementById('tipob1').checked==false)&&(document.getElementById('tipob2').checked==false)&&(document.getElementById('tipob3').checked==false)&&(document.getElementById('tipob4').checked==false)&&(document.getElementById('tipob5').checked==false)){
	...
	var direccion='inicio.php?location=listpro&tipo='+opcion+'&valor='+nombre
...
echo'
<div class="cuerpo">
		<h3>Consulta de <span>Hoja de Producci&oacute;n</span></h3>
		<p>Elija la Opci&oacute;n de b&uacute;squeda deseada para Consultar las Hojas de producci&oacute;n</p>
		<form action="" method="post">
			<table>
				...
				<tr>
					<td colspan="3">
					<div align="center"><input type="button" id="bbusc" name="bbusc" value="Ver Producciones" onclick="Buscar()" /></div></td>
				</tr>
			</table>
		</form>
</div>';
