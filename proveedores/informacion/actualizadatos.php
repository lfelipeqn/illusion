...
?>
<div id="presentacion">    
<h3>Actualización de Datos Proveedor</h3>
<form id="actproveedor" name="actproveedor" action="" method="post">
	<div id="tabs">
		<ul>
			<li style="font-size: 12px;"><a href="#tabs-1">Información Proveedor</a></li>
			<li style="font-size: 12px;"><a href="#tabs-2">Información Tributaria</a></li>
			<li style="font-size: 12px;"><a href="#tabs-3">Información Pagos</a></li>
		</ul>
    	<div id="tabs-1">
			<table>
    ...
    <div id="tabs-2">
        <table>
            <tr>
            	<td><label>Tipo de Régimen</label></td>
					<td>
				...
				<tr>
					...
					<td><label id="lbresgran" name="lbresgran" >Resolución</label></td>
					<td>
						<?
				...
				<tr>
					...
					<td><label id="lbresauto">Resolución</label></td>
					<td>
						<?	
...
<div align="center"><input type="submit" value="Actualizar Informaci&oacute;n del Proveedor" style="width:100%; font-weight:bold;"/></div>
</form>
</div>
<script>
   ...
   $(document).ready(function() {	            	            
        $('#actproveedor').validate({
            ...
            messages: {
                ...
                'nnit': {required: " Ingrese el Nit", number:" El Nit debe ser un número"},
                'ndv': {required: " Ingrese Digito de Verificación", number:" El Digito debe ser un número"},
                'nciudad': {required: " Digite la Ciudad"},
                'npais': {required: " Dgite el pais"},
                'ndir': {required: " Registre la dirección"},
                'ntel': {required: " Ingrese el telefono"},
                'ncelu': {required: " Ingrese un Número movil", number:" El Móvil debe ser numero"},
                'ncorreo': {required: " Ingrese Correo", email:" Digite un correo válido"},
            ...
            submitHandler: function(form){
               ...
               var ntpersona = $('[name="ntpersona"]:checked').val()
               ...
               var ntipoc= $('[name="ntipoc"]:checked').val()
