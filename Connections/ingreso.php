<?php
	...
	$sql = "SELECT usuarios.IdUsuario, usuarios.Usuario, usuarios.Password, usuarios.Nombre, usuarios.Correo, usuarios.Rental, perfiles.Perfil FROM usuarios Inner Join perfiles ON usuarios.IdPerfil = perfiles.IdPerfil where ((Usuario='$user') AND (Password='$pass'))";
