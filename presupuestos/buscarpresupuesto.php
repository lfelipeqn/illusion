...
function Buscar(){	if((document.getElementById('tipob1').checked==false)&&(document.getElementById('tipob2').checked==false)&&(document.getElementById('tipob3').checked==false)&&(document.getElementById('tipob4').checked==false)&&(document.getElementById('tipob5').checked==false)){
	...
	var direccion='inicio.php?location=listpres&tipo='+opcion+'&valor='+nombre
...
<div class="cuerpo">
	...
	<p>Elija la Opci&oacute;n de b&uacute;squeda deseada para Consultar los Presupuestos Disponibles</p>
	<form action="" method="post">
		<table>
			...
			<tr>
				<td colspan="3">
				<div align="center"><input type="button" id="bbusc" name="bbusc" value="Ver Presupuestos" onclick="Buscar()" /></div></td>
			</tr>
		</table>
	</form>	
</div>';
